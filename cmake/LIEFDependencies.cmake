...
if(LIEF_EXTERNAL_SPDLOG)
  if(NOT TARGET spdlog::spdlog)
    message(WARNING "not target spdlog::spdlog")
    find_package(spdlog REQUIRED)
  else()
    message(WARNING "NOT not target spdlog::spdlog")
    message(WARNING "SPDLOG_DIR: ${SPDLOG_DIR}")
  endif()
  ...
  get_target_property(SPDLOG_INC_DIR2 spdlog::spdlog INCLUDE_DIRECTORIES)
  message(WARNING "SPDLOG_INC_DIR: ${SPDLOG_INC_DIR}")
  message(WARNING "SPDLOG_INC_DIR2: ${SPDLOG_INC_DIR2}")
